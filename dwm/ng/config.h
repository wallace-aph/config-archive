...
static const char normbordercolor[] = "#B0B0B0";  /* color of unselected window's border */
static const char normbgcolor[]     = "#101010";  /* color of unselected workspace bg */
static const char normfgcolor[]     = "#8C8C8C";  /* color of unselected workspace font */
static const char selbordercolor[]  = "#6A96B0";  /* color of selected window's border */
static const char selbgcolor[]      = "#101010";  /* color of selected worspace bg */
static const char selfgcolor[]      = "#6A96B0";  /* color of selected workspace font */

...
static const char font[]            = "uushi";


//static const char font[]            = "-spectrum-*-*-*-*-*-11-*-*-*-*-*-*-*";

static const char normbordercolor[] = "#2A2F36";  /* color of unselected window's border */
static const char normbgcolor[]     = "#0E1112";  /* color of unselected workspace bg */
static const char normfgcolor[]     = "#EDDEC9";  /* color of unselected workspace font */
static const char selbordercolor[]  = "#2A2F36";  /* color of selected window's border */
static const char selbgcolor[]      = "#3D444E";  /* color of selected worspace bg */
static const char selfgcolor[]      = "#EDDEC9";  /* color of selected workspace font */

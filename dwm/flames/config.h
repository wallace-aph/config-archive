...
static const char normbordercolor[] = "#293A3C";  /* color of unselected window's border */
static const char normbgcolor[]     = "#293A3C";  /* color of unselected workspace bg */
static const char normfgcolor[]     = "#F1D9B3";  /* color of unselected workspace font */
static const char selbordercolor[]  = "#293A3C";  /* color of selected window's border */
static const char selbgcolor[]      = "#F4A47E";  /* color of selected worspace bg */
static const char selfgcolor[]      = "#EEEEEE";  /* color of selected workspace font */
...
/* tagging */
static const char *tags[] = { "the", "youth", "will", "always", "win", };

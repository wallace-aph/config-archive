...
static const char font[]            = "fixed 10";

// static const char font[] = "Ubuntu Mono Bold 10";

static const char normbordercolor[] = "#794655";  /* color of unselected window's border */
static const char normbgcolor[]     = "#B65C71";  /* color of unselected workspace bg */
static const char normfgcolor[]     = "#FAFAFA";  /* color of unselected workspace font */
static const char selbordercolor[]  = "#638A7A";  /* color of selected window's border */
static const char selbgcolor[]      = "#638A7A";  /* color of selected worspace bg */
...
/* tagging */
static const char *tags[] = { "casper", "balthasar", "melchior", "matsushiro", "berlin",};
...
/* commands */
static const char *dmenucmd[] = { "dmenu_run", "-fn", "fixed:size=10:bold", "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };

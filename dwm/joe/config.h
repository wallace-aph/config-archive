...
static const char normbordercolor[] = "#58698C";  /* color of unselected window's border */
static const char normbgcolor[]     = "#1B1B1B";  /* color of unselected workspace bg */
static const char normfgcolor[]     = "#FFFFFF";  /* color of unselected workspace font */
static const char selbordercolor[]  = "#58698C";  /* color of selected window's border */
static const char selbgcolor[]      = "#1B1B1B";  /* color of selected worspace bg */
static const char selfgcolor[]      = "#596196";  /* color of selected workspace font */
